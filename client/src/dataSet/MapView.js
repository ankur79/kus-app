...
import options from "./us-states.json";
var info = L.control();
export default class MapView extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
      <div style={{position: "relative", marginBottom: 20,  zIndex: 5000, width: "50%"}}>
          <Select className="basic-single" options={options} onChange={opt => this.addStateMap(opt.label)}/>
        </div>
        <div>
